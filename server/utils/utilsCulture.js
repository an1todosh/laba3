...
const culture = async (request, role, response) => {
...
const getCulture = async (req, role, res) => {
...
const deleteCulture = async (req,role,res)=>{
...
const UpDateCulture = async (req,role,res) =>{
