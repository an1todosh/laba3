...
const economy = async (request, role, response) => {
...
const getEconomy = async (req, role, res) => {
...
const deleteEconomy = async (req,role,res)=>{
...
const UpDateEconomy = async (req,role,res) =>{
